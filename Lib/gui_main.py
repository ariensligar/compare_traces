...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionX_Axis_Is_Time.setText(QCoreApplication.translate("MainWindow", u"X Axis is Time", None))
        self.actionX_Axis_Is_Distance.setText(QCoreApplication.translate("MainWindow", u"X Axis is Distance", None))
        self.actionX_Axis_Is_Default.setText(QCoreApplication.translate("MainWindow", u"X Axis Is Default", None))
